...
//CS202
//Program 4
//This is an implementation of CS163 class.
//CS163 class is derived from media class.
//This media type represents one class type in the array of linear linked lists.

import java.util.*;

public class CS163 extends Media {
    ...
    public CS163(String name, String description, String attachments){
