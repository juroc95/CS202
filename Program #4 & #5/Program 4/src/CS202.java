...
//CS202
//Program 4
//This is an implementation of CS202 class.
//CS202 class is derived from media class.
//This media type represents one class type in the array of linear linked lists.

import java.util.*;

public class CS202 extends Media {
    ...
    public CS202(String name, String description, String attachments){
