...
//CS202
//Program 5
//This is an implementation of general class.
//General class is derived from media class.
//This media type represents one class type in the array of linear linked lists.

import java.util.*;

public class General extends Media {
    ...
    public General(String class_name, String name, String description, String attachments){
