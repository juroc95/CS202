...
//And there are four pure virtual methods.
...
public abstract class Media {
    ...
    //pure virtual method for media type
    public abstract int media_type();
    //pure virtual method for take quiz
    public abstract int take_quiz();
    //pure virtual method for set quiz
    public abstract int set_quiz();
    //pure virtual method for remove quiz
    public abstract int remove_quiz();
    //pure virtual method for display class name
    public abstract void display_class_name();
    //set media method
