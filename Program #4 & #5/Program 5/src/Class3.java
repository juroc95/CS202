...
//CS202
//Program 5
//This is an implementation of Class 3 class.
//Class 3 class is derived from media class.
//This media type represents one class type in the array of linear linked lists.

import java.util.*;

public class Class3 extends Media {
    ...
    public Class3(String class_name, String name, String description, String attachments){
